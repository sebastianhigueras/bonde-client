export default {
  ...
  'page--account-register.form.lastname.label': 'Meu Sobrenome',
  ...
  'page--account-register.form.email.validation.invalid-email-format': 'Ops!Esse email no existe ',
  'page--account-register.form.password.label': 'Minha Senha',
